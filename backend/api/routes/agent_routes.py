...
@router.post("/chat_graph_agentically", response_model=AgentResponse)
async def chat_graph_agent(request: AgentRequest):
    try:
        ...
        print(last_message)
        return AgentResponse(response=last_message)
